...
$db = mysqli_connect("localhost","root","","5theway");
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        $check_product = "select * from cart where id_add='$id_add' AND p_id='$p_id'";
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            $query = "insert into cart (p_id,id_add,qty,size) values ('$p_id','$id_add','$product_qty','$product_size')";
